<?php
  ...
  ************************/
  ...
  $sql = "select indent.price,indent.num,shop.name,shop.img from indent,shop where indent.shop_id = shop.id and indent.code ='{$code}' limit {$offset},{$page_size}";
         ...
         <table width= 100%  border = 1 text-align = "center">
           ...
           <?php foreach ($result1 as $key => $value): ?>
             <tr>
               ...
               <td>
                 <img width = 100px height = 100px src="../public/uploads/thumb_<?php echo $value['img']; ?>" alt="">
               </td>

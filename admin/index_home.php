								...
								<div class="Shops_info clearfix">
									<div class="left_shop">
										<div class="left_shop_logo">
											<div class="shop_logo"><img src="" onerror="this.src='./public/images/noimage.gif',this.onerror=null"></div>
									...
									<div class="operating_style Quick_operation menuUl">
										<ul class="menulist">
											<li class="column-name">
												<a href="javascript:void(0)" data-id="" name="add_product.php" class="btn menuUl_title" title="添加产品">添加产品</a>
											</li>
											<li class="column-name">
												<a href="javascript:void(0)" data-id=""  name="add_Advertising.php" class="btn menuUl_title" title="添加广告">添加广告</a>
											</li>
											<li class="column-name">
												<a href="javascript:void(0)" data-id="" name="add_Article.php" class="btn menuUl_title" title="添加文章">添加文章</a>
											</li>
											<li class="column-name">
												<a href="javascript:void(0)" data-id="" name="add_Singlepag.php" class="btn menuUl_title" title="新增单页面">新增单页面</a>
											</li>
											<li class="column-name">
										       <a href="javascript:void(0)" title="个人信息" class="btn menuUl_title" name="administrators.php" data-id="111"><i class="iconfont icon-guanliyuan"></i>个人信息</a>
									       </li>
									        <li class="column-name">
										     <a href="javascript:void(0)" title="系统设置" class="btn menuUl_title" name="system_info.php" data-id="46"><i class="iconfont icon-system-copy"></i>系统设置</a>
									       </li>
										</ul>
									</div>
								</div>

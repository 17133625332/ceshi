				...
				<div class="box-content padding15">
					...
					<div class="ptb30">
					   ...
					   <div class="color3 padding10">
					   	<h3>默认显示index.php页面，框架结构以及搭好 ，只需要添加内页和修改样式，基本功能模块都有</h3>
					   scrollbar:function(e){ }自定义滚动条方法(可以自己写也可以用第三方插件)
					   <p><img src="./public/images/stencil/image9.png">示例</p>
					   </div>
					...
					<div class="ptb30">
						<h3>弹框盒子模块</h3>
						<p ><img src="./public/images/stencil/image8.png" width="200px"></p>
						<p>弹框盒子模块指定class</p>

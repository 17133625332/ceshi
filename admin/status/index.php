<?php
  ...
  ************************/
  ...
  //解析结果集资源 -- 记录总数
  $total_sql2 = "select count(*) as num from status";
  ...
  $sql = "select * from status limit {$offset},{$page_size}";
       ...
       <form class="" action="index.html" method="post">
         <table width= 100%  border = 1 text-align = "center">
           ...
           <tr>
             ...
             <td>
               <a href="./edit.php?id=<?php echo $value['id'];?>&&name=<?php echo $value['name']; ?>">修改</a>
             </td>
             <td>
               <a href="./delete.php?id=<?php echo $value['id']; ?>&&page=<?php echo $page; ?>">删除</a>
             </td>
             </tr>
